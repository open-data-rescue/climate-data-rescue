...
$.imgAreaSelect = function (img, options) {
    ...
    function areaMouseDown(event) {
				...
				$('#transcription_fieldgroups_'+$box.attr('id')).hide();
        ...
        if (resize) {
            ...
            $(document).mousemove(movingMouseMove)
                .one('mouseup', function () {
                    options.onSelectEnd(img, getSelection());
										// Move the transcription fieldgroups and show it
										$('#transcription_fieldgroups_'+$box.attr('id')).css('background', 'red');
										$('#transcription_fieldgroups_'+$box.attr('id')).css('top', selection.y2);
										$('#transcription_fieldgroups_'+$box.attr('id')).css('left', selection.x1);
										$('#transcription_fieldgroups_'+$box.attr('id')).css('width', selection.x2-selection.x1 + 'px');
										$('#transcription_fieldgroups_'+$box.attr('id')).show();
