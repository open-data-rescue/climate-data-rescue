$.widget("ui.annotate", {
    ...
    _setUpAnnotations: function() {
        ...
        for (var id in this.options.annotations) {
            ...
            if (this.options.onAnnotationAdded != null) {
                this.options.onAnnotationAdded.call(this, {
                    annotation_id: id,
                    data: this.options.annotations[id]
                });
            }
        }
    },
    ...
    showBox: function(position) {
        ...
        if (position) {
            ...
            $(this.options.zoomBox).find("img").css("top", zoomY)
                .css("left", zoomX);
            this._selectFieldgroup(this.options.initalFieldgroup);
    ...
    showBoxWithAnnotation: function(annotation) {
        ...
        this.showBox(bounds);
        this._selectFieldgroup(annotation.kind);
        ...
        $.ajax({
            ...
            data: {
                "transcription": {
                    ...
                    "page_data": this.options.page_data
                },
    ...
    _addAnnotation: function(event) {
        ...
        var zoomLevel = this.options.zoomLevel;
        var location = {
            width: zoomBox.css("width").replace(/px/, '') / zoomLevel,
        ...
        if (this.options.editing_id != null) {
            ...
            if (this.options.onAnnotationUpdated != null) {
                this.options.onAnnotationUpdated.call(this, {
                    annotation_id: this.options.editing_id,
            ...
            if (this.options.onAnnotationAdded != null) {
                this.options.onAnnotationAdded.call(this, {
                    annotation_id: this.options.annIdCounter,
                    data: annotation_data
                });
            }
    ...
    _editAnnotation: function(annotation_id) {
        ...
        if (this.options.onAnnotationEditedStarted != null) {
            this.options.onAnnotationEditedStarted.call(this, {
    ...
    _updateWithDrag: function(position) {
        ...
        this._checkAndSwitchOrientation({
            x: x,
            y: y
        });
    ...
    _generateAnnotationBox: function() {
        ...
        var annotationBox = $("<div id ='scribe_annotation_box'> </div>").draggable(this, {
    ...
    _generateHelp: function(fieldgroups) {
    ...
    _generateTabBar: function(fieldgroups) {
        ...
        $.each(fieldgroups, function() {
            ...
            tab.click(elementName, jQuery.proxy(self._switchFieldgroupType, self));
            tabBar.append(tab);
        });
        return tabBar;
    },
    _generateInputs: function(fieldgroups) {
    ...
    showHelp: function() {
        ...
        if (this.options.orientation == "floatAbove") {
            $("#scribe_annotation_help").stop().show().animate({
                "top": "-100",
                "opacity": "100"
            }, 500);
        } else {
    ...
    hideHelp: function() {
        ...
        $("#scribe_annotation_help").stop().animate({
            "top": "0",
            "opacity": "0"
        }, 500);
