...
(function(window, undefined) {
    ...
    jQuery.event = {
        ...
        fix: function(event) {
            ...
            if (!event.which && event.scribe_button !== undefined) {
                event.which = (event.scribe_button & 1 ? 1 : (event.scribe_button & 2 ? 3 : (event.scribe_button & 4 ? 2 : 0)));
            }
    ...
    function liveHandler(event) {
        ...
        if (event.liveFired === this || !events || !events.live || event.scribe_button && event.type === "click") {
            return;
        }
