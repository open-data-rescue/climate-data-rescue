// import {appStore, SET_LOCALE} from '../store/app.store'
// import Vue from 'vue'
...
//   console.debug("****** SET LOCALE", to.params)
//   let { locale } = to.params

//   if (!locale) {
//     locale = appStore.state.locale
//   }

//   // Do something with locale, check availability of messages etc.
//   appStore.commit(SET_LOCALE, locale)
//   next()
// }
